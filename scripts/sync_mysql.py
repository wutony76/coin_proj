...
def main(*args):
  with connection.cursor() as cursor:
    ...
    sql = """CREATE TABLE IF NOT EXISTS system (
      ...
      `ant_index` INT NOT NULL DEFAULT 0,
      `cash_index` INT NOT NULL DEFAULT 0,
      `pay_index` INT NOT NULL DEFAULT 0
    )"""
    sqls.append(sql)

    #sql = """INSERT INTO system (`ant_index`, `cash_index`, `pay_index`) VALUES ('0', '0', '0')"""
    #sqls.append(sql)


    sql = """CREATE TABLE IF NOT EXISTS ant_users (
      `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    sql = """CREATE TABLE IF NOT EXISTS cash (
      `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
      `ant_id` VARCHAR(64) NOT NULL,
      `whose_id` VARCHAR(64) NOT NULL,
      `out_sn` VARCHAR(128) NOT NULL,
    ...
    sql = """CREATE TABLE `coin_dev2`.`pay` (
      `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
      `ant_id` VARCHAR(64) NOT NULL,
      `whose_id` VARCHAR(64) NOT NULL,
      `out_sn` VARCHAR(128) NOT NULL,
