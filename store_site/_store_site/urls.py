...
from store_site import views, test_views, debug_views, log_views
from store_site import stats_views
from store_site import query_views

from store_site import info_views
from store_site import store_views
...
store_urls = [
  ...
  #cash_order
  #url(r'^cash_add$', store_views.pay_add_view, name='pay_add'),
  #url(r'^cash_query$', store_views.pay_query_view, name='pay_query'),
